...
setTimeout(function(){
  ...
  const player2 = {
    ...
    render(counter) {
      ...
      if(session2 == "character3"){
        ...
        //versuch animation Spieler in-game
        const playerblue1Canvas = document.createElement('canvas');
        const playerblue1 = playerblue1Canvas.getContext('2d');
        var sb1 = document.getElementById('sp_blau1');
        playerblue1.width = playerblue1.height = grid;
        playerblue1.drawImage(sb1, x, y);

        const playerblue2Canvas = document.createElement('canvas');
        const playerblue2 = playerblue2Canvas.getContext('2d');
        var sb2 = document.getElementById('sp_blau2');
        playerblue2.width = playerblue2.height = grid;
        playerblue2.drawImage(sb2, x, y);

        const playerblue3Canvas = document.createElement('canvas');
        const playerblue3 = playerblue3Canvas.getContext('2d');
        var sb3 = document.getElementById('sp_blau3');
        playerblue3.width = playerblue3.height = grid;
        playerblue3.drawImage(sb3, x, y);

        sbarray = [sb1, sb2, sb3];
        
        
        sbf2= sbarray[counter];
        
        console.log(counter)
        console.log(sbf2);

        context.beginPath();
        context.drawImage(sbf2, x, y);
        context.fill();
      }
    }
  }
  ...
  function loop(timestamp) {
    ...
    player2.render(counter);
    player1.render(counter);
  }
